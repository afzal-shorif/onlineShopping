<?php
    /**
     *  file name CheckPassword.php
     *  contain a php class
     *  use for create admin only
     *  the class is imitation from book (Apress) PHP Solutions, Dynamic Web Design Made Easy 3rd (2014) by David Powers
    */
    class CheckPassword {
        protected $password;
